...
# Inputs
hours = st.number_input("Working Hours", 1.0, 15.0, 8.0)
tasks = st.number_input("Task Count", 1.0, 30.0, 10.0)
break_time = st.number_input("Break Time", 0.0, 120.0, 30.0)
weekend = st.selectbox("Weekend Work", [0, 1])
emails = st.number_input("Email Activity", 0.0, 500.0, 100.0)
...
if st.button("Predict"):
    ...
    input_data = np.array([[hours, tasks, break_time, weekend, emails, sleep,
